...
GreaselionServiceFactory::GetInstance() {
...
GreaselionServiceFactory::
~GreaselionServiceFactory() = default;

KeyedService* GreaselionServiceFactory::BuildServiceInstanceFor(
    content::BrowserContext* context) const {
  std::unique_ptr<GreaselionServiceImpl>
    greaselion_service(
...
GreaselionServiceFactory::GetBrowserContextToUse(
    content::BrowserContext* context) const {
